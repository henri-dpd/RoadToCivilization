...
class TypeCollector(object):
    ...
    def visit(self, node):
        ...
        society_type.define_method('_getCharacteristic', ['name'], [string_type], list_type)
        species_type.define_method('_getCharacteristicSummation', ['name'], [string_type], list_type)
        species_type.define_method('_getCharacteristicMean', ['name'], [string_type], list_type)
